...
public class FlowerStemBlock extends RotatedPillarBlock {
    ...
    public FlowerStemBlock(Properties properties) {
        super(properties.mapColor(MapColor.PLANT).sound(SoundType.STEM).instrument(NoteBlockInstrument.BANJO).strength(2.0F, 3.0F).ignitedByLava());
    }
}
